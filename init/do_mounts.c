...
__setup_end("load_ramdisk=", load_ramdisk);
...
__setup_link("ro", readonly,load_ramdisk);
__setup_link("rw", readwrite,readonly);
...
__setup_link("root=", root_dev_setup,readwrite);
...
__setup_link("rootflags=", root_data_setup,root_dev_setup);
__setup_link("rootfstype=", fs_names_setup,root_data_setup);
__setup_start("rootdelay=", root_delay_setup,fs_names_setup);
