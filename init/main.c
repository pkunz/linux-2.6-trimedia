...
__setup_link("maxcpus=", maxcpus,nosmp);
...
__setup_link("debug", debug_kernel,maxcpus);
__setup_link("quiet", quiet_kernel,debug_kernel);
...
__setup_link("loglevel=", loglevel,quiet_kernel);
...
__setup_link("init=", init_setup,loglevel);
...
__setup_link("rdinit=", rdinit_setup,init_setup);
...
static int __init do_early_param(char *param, char *val)
{
	...
	for(p=init_setup_list_ptr; p!=NULL; p=p->next) {
...
static int kparam_list_count(void)
{
	int count=0;
	struct kernel_param* kp = __kernel_param_list_ptr;
...
__setup_start("initcall_debug", initcall_debug_setup,rdinit_setup);
...
{
	call_initcall_list(initcall_1_list_ptr);
	call_initcall_list(initcall_2_list_ptr);
	call_initcall_list(initcall_3_list_ptr);
	call_initcall_list(initcall_4_list_ptr);
	call_initcall_list(initcall_5_list_ptr);
	call_initcall_list(initcall_6_list_ptr);
	call_initcall_list(initcall_7_list_ptr);
