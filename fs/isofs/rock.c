...
static int rock_check_overflow(struct rock_state *rs, int sig)
{
	...
	case SIG('C', 'E'):
		...
		break;
	case SIG('E', 'R'):
		len = sizeof(struct SU_ER_s) - sizeof(char);
		break;
	case SIG('R', 'R'):
	...
	case SIG('P', 'N'):
		...
		break;
	case SIG('S', 'L'):
		len = sizeof(struct RR_SL_s) - sizeof(char);
		break;
	case SIG('N', 'M'):
		len = sizeof(struct RR_NM_s) - sizeof(char);
		break;
	case SIG('C', 'L'):
	...
	case SIG('P', 'L'):
		...
		break;
	case SIG('T', 'F'):
		len = sizeof(struct RR_TF_s) - sizeof(struct stamp);
		break;
	case SIG('Z', 'F'):
