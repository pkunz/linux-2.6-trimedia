...
__setup_end("hcheck_tick", hangcheck_parse_tick);
__setup_link("hcheck_margin", hangcheck_parse_margin,hangcheck_parse_tick);
__setup_link("hcheck_reboot", hangcheck_parse_reboot,hangcheck_parse_margin);
__setup_start("hcheck_dump_tasks", hangcheck_parse_dump_tasks,hangcheck_parse_reboot);
#endif /* not MODULE */
