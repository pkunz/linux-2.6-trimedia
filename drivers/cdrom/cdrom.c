...
module_param_end(debug, bool, 0);
module_param_link(autoclose, bool, 0,debug);
module_param_link(autoeject, bool, 0,autoclose);
module_param_link(lockdoor, bool, 0,autoeject);
module_param_link(check_media_type, bool, 0,lockdoor);
module_param_start(mrw_format_restart, bool, 0,check_media_type);
