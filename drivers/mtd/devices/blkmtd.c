...
__setup_end("blkmtd_device=", param_blkmtd_device);
__setup_link("blkmtd_erasesz=", param_blkmtd_erasesz,param_blkmtd_device);
__setup_link("blkmtd_ro=", param_blkmtd_ro,param_blkmtd_erasesz);
__setup_start("blkmtd_sync=", param_blkmtd_sync,param_blkmtd_ro);
