...
__setup_end("MTD_Region=", MTD_New_Region);
__setup_link("MTD_Partition=", MTD_New_Partition,MTD_New_Region); 
/* Backwards-spelling-compatibility */

__setup_start("MTD_Partion=", MTD_New_Partition,MTD_New_Partition);
