...
__setup_end("pnp_reserve_irq=", pnp_setup_reserve_irq);
...
__setup_link("pnp_reserve_dma=", pnp_setup_reserve_dma,pnp_setup_reserve_irq);
...
__setup_link("pnp_reserve_io=", pnp_setup_reserve_io,pnp_setup_reserve_dma);
...
__setup_start("pnp_reserve_mem=", pnp_setup_reserve_mem,pnp_setup_reserve_io);
