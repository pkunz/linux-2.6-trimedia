...
module_param_end(tulip_debug, int, 0);
module_param_link(max_interrupt_work, int, 0,tulip_debug);
module_param_link(rx_copybreak, int, 0,max_interrupt_work);
module_param_link(csr0, int, 0,rx_copybreak);
module_param_array_link(options, int, NULL, 0,csr0);
module_param_array_start(full_duplex, int, NULL, 0,options);
