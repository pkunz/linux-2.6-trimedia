...
module_param_end(multicast_filter_limit, int, 0);
module_param_array_link(media, int, NULL, 0,multicast_filter_limit);
module_param_array_link(full_duplex, int, NULL, 0,media);
module_param_start(debug, int, 0,full_duplex);
