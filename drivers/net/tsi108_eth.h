...
#ifdef CONFIG_TAIGA			/* Freescale HPC2 */
...
#elif defined(CONFIG_TSI108EVB)		/* Tundra TSI108_EVB */
#	define TSI108_PHY0_ADDR	(1)	/* PHY address for GIGE port 0 */
#	define TSI108_PHY1_ADDR	(2)	/* PHY address for GIGE port 1 */
#	define TSI108_PHY_TYPE	PHY_BCM54XX
#elif defined(CONFIG_TSI108SVB)		/* Tundra TSI108_SVB */
#	define TSI108_PHY0_ADDR	(0)	/* PHY address for GIGE port 0 */
#	define TSI108_PHY1_ADDR	(1)	/* PHY address for GIGE port 1 */
#	define TSI108_PHY_TYPE	PHY_MV88E
#endif
...
#define TSI108_MAC_CFG1			(0x000 / 4)
...
#define TSI108_MAC_CFG2			(0x004 / 4)
...
#define TSI108_STAT_CARRY2		(0x104 / 4)
...
#define TSI108_STAT_CARRYMASK1		(0x108 / 4) 
#define TSI108_STAT_CARRYMASK2		(0x10c / 4) 

#define TSI108_EC_PORTCTRL		(0x200 / 4)
...
#define TSI108_EC_INTSTAT		(0x204 / 4)
#define TSI108_EC_INTMASK		(0x208 / 4)
...
#define TSI108_EC_TXCFG			(0x220 / 4)
#define TSI108_EC_TXCFG_RST		(1 << 31)

#define TSI108_EC_TXCTRL		(0x224 / 4)
...
#define TSI108_EC_TXERR			(0x278 / 4)

#define TSI108_EC_TXQ_CFG		(0x280 / 4)
...
#define TSI108_EC_TXQ_BUFCFG		(0x284 / 4)
...
#define TSI108_EC_HASHADDR		(0x360 / 4)
...
#define TSI108_EC_HASHDATA		(0x364 / 4)

#define TSI108_EC_RXQ_PTRLOW		(0x388 / 4)

#define TSI108_EC_RXQ_PTRHIGH		(0x38c / 4)
...
#define TSI108_EC_RXQ_CFG		(0x380 / 4)
...
#define TSI108_EC_RXQ_BUFCFG		(0x384 / 4)
