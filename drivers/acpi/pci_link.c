...
__setup_end("acpi_irq_isa=", acpi_irq_isa);
...
__setup_link("acpi_irq_pci=", acpi_irq_pci,acpi_irq_isa);
...
__setup_link("acpi_irq_nobalance", acpi_irq_nobalance_set,acpi_irq_pci);
...
__setup_start("acpi_irq_balance", acpi_irq_balance_set,acpi_irq_nobalance_set);
