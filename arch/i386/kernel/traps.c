...
#include <asm/ltt/ltt-facility-custom-stack_arch_i386.h>
#include <asm/ltt/ltt-facility-stack_arch_i386.h>
...
asmlinkage void trace_real_syscall_entry(struct pt_regs *regs)
{
	...
	if(user_mode_vm(regs)) {
		lttng_sequence_stack_arch_process_dump_eip sequence;
		sequence.len = 0;	/* pass the regs to the custom write */
		sequence.array = (const unsigned long*)regs;
		trace_stack_arch_process_dump(&sequence);
	}
}
