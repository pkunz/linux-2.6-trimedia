...
#ifndef __ASM_TRIMEDIA_PNX1005_SWITCH_H
#define __ASM_TRIMEDIA_PNX1005_SWITCH_H
...
#define RESTORE_NEXT_SWITCH_STACK 					\
	...
	IF r1   nop, 							\
	IF r1   nop, 							\
	IF r1   ld32d(0) REG_SWTO_NEXT_KSP -> REG_temp3,                \
	IF r1   nop, 							\
	IF r1   nop, 							\
	IF r1   nop, 							\
	IF r1   nop; 							\
	...
	IF r1   nop, 							\
	IF r1   nop, 							\
	IF r1   ld32d(12) REG_SWTO_NEXT_KSP -> REG_temp4,              	\
	IF r1   nop, 							\
	IF r1   nop, 							\
	IF r1   nop, 							\
	IF r1   nop; 							\
	...
	IF r1   nop, 							\
	IF r1   nop, 							\
	IF r1   ld32d(16) REG_SWTO_NEXT_KSP -> REG_temp5,              	\
	IF r1   nop, 							\
	IF r1   nop, 							\
	IF r1   nop, 							\
	IF r1   nop; 							\
...
#define UPDATE_CURRENT_THREAD_INFO 					\
	(* cycle 0 *) 							\
	IF r1   nop,                             			\
	IF r1   imm32(SYMBOL_NAME(__current_thread_info)) -> REG_temp, 	\
	IF r1   nop, 							\
	IF r1   nop, 							\
	IF r1   nop, 							\
	IF r1   nop, 							\
...
#endif /*__ASM_TRIMEDIA_PNX1005_SWITCH_H*/
