/*
 * arch/ppc/boot/simple/misc-katanaQp.c
 *
...
{
	mv64x60_console_baud = KATANAQP_DEFAULT_BAUD;
	mv64x60_mpsc_clk_src = KATANAQP_MPSC_CLK_SRC;
	mv64x60_mpsc_clk_freq =
		min(katanaQp_bus_freq((void __iomem *)KATANAQP_CPLD_BASE),
