...
/* console_baud has an additional optional override based on the 
 * CONFIG_SERIAL_MPSC_CONSOLE_BAUD setting used later in this file.
 */
#if defined(CONFIG_EV64360)
...
#elif defined(CONFIG_CONFIG_KATANAQP)
#include <platforms/katanaQp.h>
u32	mv64x60_console_baud = KATANAQP_DEFAULT_BAUD;
u32	mv64x60_mpsc_clk_src = KATANAQP_MPSC_CLK_SRC; /* TCLK */
u32	mv64x60_mpsc_clk_freq = KATANAQP_MPSC_CLK_FREQ;
#elif defined(CONFIG_POWERPMC280)
#include <platforms/ppmc280.h>
u32	mv64x60_console_baud = PPMC280_DEFAULT_BAUD;
u32	mv64x60_mpsc_clk_src = PPMC280_MPSC_CLK_SRC; /* TCLK */
u32	mv64x60_mpsc_clk_freq = PPMC280_MPSC_CLK_FREQ;
#else
...
serial_init(int chan, void *ignored)
{
	...
	/* Override for platforms that have various bootloaders avail.  */
#ifdef CONFIG_SERIAL_MPSC_CONSOLE_BAUD
	mv64x60_console_baud = CONFIG_SERIAL_MPSC_CONSOLE_BAUD;
#endif
