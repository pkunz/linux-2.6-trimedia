...
/*
 * Timer init happens before mem_init but after paging init, so we
cannot
 * directly use ioremap() at that time.
 * late_time_init() is call after paging init.
 */

static void sbc8560_time_init(void)
{
      struct timespec tv;

       TODC_INIT(TODC_TYPE_MK48T59, 0, 0, SBC8560_TODC_NVRAM_ADDR, 0);
	      ...
	      unsigned long r6, unsigned long r7)
{
	...
	ppc_md.get_rtc_time = NULL;
       ...
       late_time_init = sbc8560_time_init;
#endif
