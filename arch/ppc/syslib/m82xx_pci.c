...
#else /* SBC82xx */
extern int pq2pci_map_irq(struct pci_dev *dev, unsigned char idsel,
                               unsigned char pin);
extern void m8260_setup_pci(struct pci_controller *hose);
#endif /* !SBC82xx */
 ...
 */
static void
pq2_setup_pci(struct pci_controller *hose)
{
	__u32 val;
	volatile cpm2_map_t *immap = cpm2_immr;
...
void __init pq2_find_bridges(void)
{
	...
	hose->mem_space.end = M82xx_PCI_UPPER_MEM;
