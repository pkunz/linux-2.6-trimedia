...
module_param_end(fast_convergence, int, 0644);
MODULE_PARM_DESC(fast_convergence, "turn on/off fast convergence");
module_param_link(max_increment, int, 0644,fast_convergence);
MODULE_PARM_DESC(max_increment, "Limit on increment allowed during binary search");
module_param_link(low_window, int, 0644, max_increment);
MODULE_PARM_DESC(low_window, "lower bound on congestion window (for TCP friendliness)");
module_param_link(beta, int, 0644,low_window);
MODULE_PARM_DESC(beta, "beta for multiplicative increase");
module_param_link(low_utilization_threshold, int, 0644,beta);
MODULE_PARM_DESC(low_utilization_threshold, "percent (scaled by 1024) for low utilization mode");
module_param_link(low_utilization_period, int, 0644, low_utilization_threshold);
MODULE_PARM_DESC(low_utilization_period, "if average delay exceeds then goto to low utilization mode (seconds)");
module_param_link(initial_ssthresh, int, 0644, low_utilization_period);
MODULE_PARM_DESC(initial_ssthresh, "initial value of slow start threshold");
module_param_start(smooth_part, int, 0644,initial_ssthresh);
