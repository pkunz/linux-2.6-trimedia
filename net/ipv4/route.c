...
static int ip_route_output_slow(struct rtable **rp, const struct flowi *oldflp)
{
	...
	fl.nl_u.ip4_u.saddr=oldflp->fl4_src;
	fl.nl_u.ip4_u.tos=tos&IPTOS_RT_MASK;
	fl.nl_u.ip4_u.scope=((tos & RTO_ONLINK) ?  RT_SCOPE_LINK : RT_SCOPE_UNIVERSE);
#ifndef CONFIG_IP_ROUTE_FWMARK
	fl.nl_u.ip4_u.fwmark=oldflp->fl4_fwmark;
#endif 
