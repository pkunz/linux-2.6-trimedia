...
#define BRCM_SERIAL_PORT_DEFNS				\
	...
	//THT for Now _BRCM_16550_INIT(BRCM_SERIAL2_IRQ, BRCM_SERIAL2_BASE),

	// THT for Now _BRCM_16550_INIT(BRCM_SERIAL3_IRQ, BRCM_SERIAL3_BASE),	
...
#define _BRCM_16550_INIT(int, base)			\
	{ baud_base:  ( BRCM_BASE_BAUD ),		\
	  irq: int,								\
	  flags: STD_COM_FLAGS,	/* THT Added Warp for 375000 baud */\
	  iomem_base: (u8 *) base,				\
	  iomem_reg_shift: 2,					\
	  io_type: SERIAL_IO_MEM /* 4 byte aligned */ \
	}
