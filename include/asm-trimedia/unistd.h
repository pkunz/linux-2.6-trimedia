...
#ifndef _ASM_TRIMEDIA_UNISTD_H_
#define _ASM_TRIMEDIA_UNISTD_H_
...
extern long __syscall(unsigned long syscall_nr,unsigned long arg1,unsigned long arg2,
...
#ifndef cond_syscall
#define cond_syscall(x) asmlinkage long x(void){ return -ENOSYS;}
#endif 

#endif /* _ASM_TRIMEDIA_UNISTD_H_ */
