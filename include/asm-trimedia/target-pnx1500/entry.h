...
*/
/* 
 * include/asm-trimedia/target-pnx1500/entry.h
 * defines the macro used in interrupt entry point and exit point for pnx1500
 * 
 ...
 */
#ifndef _ASM_TRIMEDIA_PNX1500_ENTRY_H
#define _ASM_TRIMEDIA_PNX1500_ENTRY_H
...
#define INTERRUPT_DELAY  						\
	(* interrupt/exception handler: inserted 2 empty delay *) 	\
	nop, nop, nop, nop, nop;		(* empty instruction *) \
	nop, nop, nop, nop, nop;		(* empty instruction *)
...
#define SWITCH_STACK 								\
	...
	IF r1   uimm(SYMBOL_NAME(__current_thread_info)) -> REG_temp1,      	\
	IF r1   nop, 								\
	IF r1   nop, 								\
	IF r1   nop; 								\
 										\
	...
	IF r1   nop; 								\
 										\
	(* cycle 6 *) 								\
	IF r1   bitor REG_temp3 REG_temp2 -> REG_temp4,                     	\
	IF r1   nop, 								\
	IF r1   nop, 								\
	IF r1   nop, 								\
	IF r1   nop; 								\
	...
	IF r1   nop; 								\
 										\
	(* cycle 10 *) 								\
	IF r1   bitinv REG_temp4 -> REG_temp1,                     		\
...
#define SAVE_ALL 							\
	(* cycle 0 *) 							\
	IF r1   uimm(SIZEOF_STRUCT_PT_REGS) -> REG_temp1,               \
	IF r1   nop, 							\
	IF r1   nop, 							\
	IF r1   nop, 							\
	IF r1   nop; 							\
...
#define  RESTORE_ALL 							\
	(* cycle 0 *) 							\
	IF r1   uimm(SIZEOF_STRUCT_PT_REGS) -> REG_temp3,               \
