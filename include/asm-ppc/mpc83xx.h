...
#ifdef CONFIG_SBC834x
#include <platforms/83xx/sbc834x.h>
#endif

/* Offsets not specific to any platform */
#define MPC83xx_IIC1_OFFSET    0x3000
#define MPC83xx_IIC2_OFFSET    0x3100

#define MPC83xx_TSEC1_OFFSET   0x24000
#define MPC83xx_TSEC2_OFFSET   0x25000

#define MPC83xx_UART1_OFFSET   0x4500
#define MPC83xx_UART1_SIZE     0x100
#define MPC83xx_UART2_OFFSET   0x4600
#define MPC83xx_UART2_SIZE     0x100
