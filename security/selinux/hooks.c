...
#if defined(CONFIG_SECURITY_SELINUX_DEVELOP) && !defined(CONFIG_SECURITY_SELINUX_BOOTPARAM)
...
#if defined(CONFIG_SECURITY_SELINUX_BOOTPARAM) && !defined(CONFIG_SECURITY_SELINUX_DEVELOP)
__setup("selinux=", selinux_enabled_setup);
#endif 

#if defined(CONFIG_SECURITY_SELINUX_DEVELOP) && defined(CONFIG_SECURITY_SELINUX_BOOTPARAM)
__setup_end("enforcing=", enforcing_setup);
__setup_start("selinux=", selinux_enabled_setup,enforcing_setup);
#endif 
